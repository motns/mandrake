module Mandrake
  ...
  #
  # Each validator has a pre-defined number of inputs. "Simple" validators (like {Mandrake::Validator::Length})
  # take a single value, whereas "complex" validators (like {Mandrake::Validator::ValueMatch}) take
  # two or more.
  #
  ...
  module Validator
    ...
    class Base
      ...
      def self.inherited(descendant)
        ...
        ::Mandrake::Validator.type_registry[id] = descendant
      end
    end
  end
end